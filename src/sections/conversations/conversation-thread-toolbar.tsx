...
interface ConversationThreadToolbarProps {
  participants?: Participant[];
}

export const ConversationThreadToolbar: FC<ConversationThreadToolbarProps> = (props) => {
...
ConversationThreadToolbar.propTypes = {
  // @ts-ignore
